...
2. **Settlement is self-referential.** Redemption pays the debate's own verdict; there is no
   ...
   tallied rating, so a single market is resolved by everything argued beneath it — yet the tree
